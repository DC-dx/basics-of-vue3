	...
	<div class="container-fluid wraper">
		...
		<div class="row">
			<div class="col-xs-3 col-md-3 col-lg-3 col-xl-3">
				...
				<router-link active-class="active" class="list-group-item" to="/slot1">9.1 slot_name</router-link>
				<router-link active-class="active" class="list-group-item" to="/slot2">9.2 defaultSlot</router-link>
				<router-link active-class="active" class="list-group-item" to="/slot3">9.3 functionSlot</router-link>
			</div>
